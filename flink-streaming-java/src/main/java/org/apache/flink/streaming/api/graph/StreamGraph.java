...
import org.apache.flink.streaming.api.operators.SimpleSourceOperatorFactory;
	...
	public <IN, OUT> void addOperator(
		...
		if (operatorFactory.isStreamSource()) {
			Class<? extends AbstractInvokable> invokableClass =
					operatorFactory instanceof SimpleSourceOperatorFactory ?
							SourceOperatorStreamTask.class : SourceStreamTask.class;
