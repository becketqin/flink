...
public class RpcSourceCoordinatorDelegate implements InputSplitProvider, SourceCoordinatorDelegate {
	private final JobMasterGateway jobMasterGateway;
	private final JobVertexID jobVertexID;
	private final ExecutionAttemptID executionAttemptID;
	private final Time timeout;

	public RpcSourceCoordinatorDelegate(
	...
	public CompletableFuture<Void> sendOperatorEvent(OperatorEvent event) {
		return jobMasterGateway.handleOperatorEvent(event, jobVertexID, executionAttemptID);
	}
}
