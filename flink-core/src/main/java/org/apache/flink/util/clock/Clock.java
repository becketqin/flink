 ...
 * <h3>Absolute Time</h3>
 *
 * <p>This refers to real world wall clock time, and it typically
 * derived from a system clock. It is subject to clock drift and inaccuracy, and can jump
 * if the system clock is adjusted. Absolute time behaves similar to {@link System#currentTimeMillis()}.
 *
 * <h3>Relative Time</h3>
 *
 ...
 * Relative time behaves similar to {@link System#nanoTime()}.
 */
