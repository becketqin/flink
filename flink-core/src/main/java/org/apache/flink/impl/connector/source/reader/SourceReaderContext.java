...
public interface SourceReaderContext {
	 ...
	 * @return A future that will be completed when the event has been processed by the split enumerator.
	 */
	CompletableFuture<Void> sendSourceEvent(SourceEvent event);
}
