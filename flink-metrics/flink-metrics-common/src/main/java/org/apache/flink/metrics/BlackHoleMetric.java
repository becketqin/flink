 ...
 * does nothing when record values and does not expect any reading.
 *
 * <p>We create this class so the actual metric reporting logic in each component does not have to distinguish between
 * enabled and disabled metrics.
 */
